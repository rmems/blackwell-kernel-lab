...
Columns: `run_id,timestamp_utc,profile,engine,model_id,concurrency,tool_loop_p50_ms,ttft_p50_ms,tpot_p50_ms,vram_peak_mb,empty_eager_us_per_launch,empty_graph_us_per_launch,empty_speedup,empty_chain_eager_us_per_kernel,empty_chain_graph_us_per_kernel,empty_chain_speedup,saxpy_eager_us_per_launch,saxpy_graph_us_per_launch,saxpy_speedup,notes`
...
| `benchmarks` | Optional synthetic-kernel measurements. The CSV exports the empty, empty-chain, and SAXPY eager/graph latency and speedup fields when present. |
