...
| #8 / RM-183 | L1 prefix / KV reuse | **Measured** (prefix-first: 15.02× prompt-eval median) |
...
1,462-token prompt reduced median prompt evaluation from 351.043 ms to 23.369
ms (93.34%, 15.02×) across three independent invocations. Streaming resume
TTFT fell from 411.945 ms to 26.994 ms. All three cleared the 10% gate while
retaining 3,428–3,477 MiB of free VRAM. Policy: keep byte-stable
