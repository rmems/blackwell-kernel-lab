...
| #17 / RM-471 | L2 Green Context SM isolation | **Measured** (`bkl_green_ctx_bench`; 98.54% lower critical-kernel median) |
...
the critical-kernel median fell from 9.6455–9.6550 ms on ordinary high-priority
streams to 0.1406–0.1412 ms on the isolated partition (98.54% lower), with
